...
![Interface de chargement des données](10.png){fig-align="center" fig-pos="H" width="85%"}
...
![Exemple : Nom : Villarreal CF, Saison 2008/2009](1.png){fig-align="center" fig-pos="H" width="85%"}
...
![Exemple : Historique Confrontation Rafael Nadal vs Novak Djokovic](2.png){fig-align="center" fig-pos="H" width="85%"}
...
![Exemple : Classement FRANCE Ligue 1 --- Saison 2012/2013](3.png){fig-align="center" fig-pos="H" width="85%"}
...
![Exemple : Stan Wawrinka, Saison : 2024](4.png){fig-align="center" fig-pos="H" width="85%"}
...
![Exemple : Villarreal CF](5.png){fig-align="center" fig-pos="H" width="85%"}
...
![Exemple : Évolution nombre de points du Real Madrid CF](6.png){fig-align="center" fig-pos="H" width="85%"}
...
![Exemple : Novak Djokovic, Saison : 2024](7.png){fig-align="center" fig-pos="H" width="85%"}

Pour le basketball, nous avons ajouté des statistiques collectives avancées comme le Net Rating ou le eFG%.

![Exemple : Golden State Warriors, Saison 2022-2023](8.png){fig-align="center" fig-pos="H" width="85%"}
...
![Exemple : Distribution de la taille moyenne par pays (Hommes), JO 2024](9.png){fig-align="center" fig-pos="H" width="85%"}
